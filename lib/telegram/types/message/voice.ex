defmodule Telegram.Types.Message.Voice do
  @moduledoc """
  ...
  @type input_type :: %{
    ...
    required(String.t) => Telegram.Types.Voice.input_type}
  ...
  def from_map(%{
    ...
    {:ok, %__MODULE__{
      ...
      voice:                    to_struct(voice, Telegram.Types.Voice)
    }}
  end
  def from_map(_) do
    {:error, %Telegram.Error{message: "Invalid Message data"}}
