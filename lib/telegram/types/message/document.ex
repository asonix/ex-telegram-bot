defmodule Telegram.Types.Message.Document do
  @moduledoc """
  ...
  @type input_type :: %{
    ...
    required(String.t) => Telegram.Types.Document.input_type,
  ...
  @type t :: %__MODULE__{
              ...
              document:                 Telegram.Types.Document.t,
  ...
  def from_map(%{
    ...
    {:ok, %__MODULE__{
      ...
      document:                 to_struct(document, Telegram.Types.Document),
      caption:                  map["caption"]
    }}
  end
  def from_map(_) do
