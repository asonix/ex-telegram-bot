defmodule Telegram.Types.Message.Audio do
  @moduledoc """
  ...
  @type input_type :: %{
    ...
    required(String.t) => Telegram.Types.Audio.input_type
  }
  ...
  ## Examples
      ...
      iex> Telegram.Types.Message.Audio.from_map(%{ "message_id" => 5, "date" => 0 })
      {:ok, %Telegram.Types.Message.Audio{message_id: 5, date: 0}}

      iex> Telegram.Types.Message.Audio.from_map(%{})
      {:error, %Telegram.Error{message: "Invalid Message data"}}

  """
  @spec from_map(input_type) :: {:ok, t} | {:error, Telegram.Error.t}
  def from_map(%{"message_id" => message_id, "date" => date, "audio" => audio}=map) do
    {:ok, %__MODULE__{
      ...
      audio:                    to_struct(audio, Telegram.Types.Audio)
    }}
  end
  def from_map(_) do
    {:error, %Telegram.Error{message: "Invalid Message data"}}
  ...
  ## Examples
      ...
      iex> Telegram.Types.Message.Audio.from_map!(%{ "message_id" => 5, "date" => 0 })
      %Telegram.Types.Message.Audio{message_id: 5, date: 0}
